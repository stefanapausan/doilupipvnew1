...
function validateForm(event) {
  var number = document.getElementById('edit-telefon-client').value
  if (!validateNumber(number)) {
    alert('Numarul de telefon nu este valid')
    const ele = document.getElementById('result')
    ele.innerHTML = 'Numarul de telefon nu este valid'
    ele.style.color = 'red'
  } else {
    const ele = document.getElementById('result')
    ele.innerHTML = 'Datele au fost salvate'
    ele.style.color = 'green'
  }
  event.preventDefault()
}

document.getElementById('proces-verbal-form').addEventListener('submit', validateForm);
/**
 * @file
 * Progress bar.
 */
